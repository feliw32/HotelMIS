...
{
    public partial class frmMasterStay : Form
    {
        ...
        public frmMasterStay(MasterStay prmRoom = null)
        {
            InitializeComponent();
            oSession = SessionProvider.GetNewUnitOfWork();
            if (prmRoom != null)
                oMasterStay = oSession.GetObjectByKey<MasterStay>(prmRoom.Oid);
            ResetData();
            LoadCombo();
            ...
            else
            {
                ...
                seDiscountByAmount.Properties.ReadOnly = false;
                seDiscountByPercent.Properties.ReadOnly = false;
                luGuest.Properties.ReadOnly = false;
            }
        }
        ...
        private void btnCancel_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                if (FormHelper.QuestionMessage("Are you sure want to cancel this data ?"))
                {
                    ...
                    {
                        if (oMasterStay.Note == string.Empty)
                        {
        ...
        private void ResetData()
        {
            if (oMasterStay == null)
            {
                oMasterStay = new MasterStay(oSession);
            }
        ...
        private void frmMasterStay_Load(object sender, EventArgs e)
        {
