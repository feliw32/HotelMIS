...
{
    [DefaultClassOptions]
    public class PaymentMethod : MyObjectBase
    {
        ...
        public static XPCollection<PaymentMethod> DataCollection(Session prmSession)
        {
            return new XPCollection<PaymentMethod>(prmSession);
        }
        ...
        public override string ToString()
        {
            ...
            return String.Format("PaymentMethod {0}-{1}", strCode, strName);
        }
    }
}