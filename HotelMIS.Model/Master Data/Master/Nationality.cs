...
namespace HotelMIS.Model
{
    ...
    public class Nationality : MyObjectBase
    {
        private String _code;
        private String _name;

        public Nationality(Session session)
            : base(session)
        {
        ...
        public static XPCollection<Nationality> DataCollection(Session prmSession)
        {
            return new XPCollection<Nationality>(prmSession);
        }
        ...
        public override string ToString()
        {
            ...
            return String.Format("Nationality {0}-{1}", strCode, strName);
        }
    }
}