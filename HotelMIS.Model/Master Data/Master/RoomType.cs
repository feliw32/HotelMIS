...
{
    [DefaultClassOptions]
    public class RoomType : MyObjectBase
    {
        private String _code;
        private String _name;

        public RoomType(Session session)
            : base(session)
        {
        ...
        public static XPCollection<RoomType> DataCollection(Session prmSession)
        {
            return new XPCollection<RoomType>(prmSession);
        }
        ...
        public override string ToString()
        {
            ...
            return String.Format("RoomType {0}-{1}", strCode, strName);
        }
    }
}